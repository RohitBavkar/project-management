        ...
        <div className="w-full flex items-center justify-end ms-auto md:justify-between gap-x-1 md:gap-x-3">
          ...
          <div className="flex flex-row items-center justify-end gap-1">
            ...
            <div className="relative inline-flex">
              ...
              <div
                className={`opacity-100 min-w-60 bg-white shadow-md rounded-lg mt-2  after:h-4 after:absolute after:-bottom-4 after:start-0 after:w-full before:h-4 before:absolute before:-top-4 before:start-0 before:w-full ${
                  active ? "active-profile-menu" : "hidden"
                }`}
              >
